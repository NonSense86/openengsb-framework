...
public class MessageFormatIT extends AbstractPreConfiguredExamTestHelper {
    ...
    public static final String VOID_CALL_STRING = ""
            ...
            + "  \"methodName\" : \"audit\","
            + "  \"args\" : [ {"
            + "    \"@type\" : \"org.openengsb.core.api.Event\","
            + "    \"name\" : \"testMessage\","
            + "    \"processId\" : null,"
            + "    \"origin\" : null"
            + "  } ],"
    ...
    public static final String METHOD_CALL_WITH_MODEL_PARAMETER = ""
            ...
            + "  \"args\" : [ {"
            + "    \"@type\" : \"org.openengsb.core.api.model.OpenEngSBModelWrapper\","
    ...
    public static final String CONNECTOR_REGISTRATION_MESSAGE = ""
            ...
            + "      \"methodName\" : \"create\","
            + "      \"args\" : [ {"
            + "        \"@type\" : \"org.openengsb.core.api.model.ConnectorId\","
            + "        \"domainType\" : \"example\","
    ...
    @Ignore("event-type causes problems-here")
    @Test
    ...
    public void createRegisterMessage() throws Exception {
        ...
        AuthenticationToken auth = new UsernamePassword("admin", "password");
    ...
    public void createUnregisterMessage() throws Exception {
        ...
        MethodCallRequest methodCallRequest = new MethodCallRequest(methodCall, false);
        AuthenticationToken auth = new UsernamePassword("admin", "password");
        SecureRequest request = SecureRequest.create(methodCallRequest, auth);
    ...
    public void createCallWithModel() throws Exception {
        ...
        MethodCall methodCall = new MethodCall("doSomething", new Object[]{ wrapper });
