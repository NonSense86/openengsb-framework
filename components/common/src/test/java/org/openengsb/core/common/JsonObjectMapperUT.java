...
public class JsonObjectMapperUT extends AbstractOsgiMockServiceTest {
    ...
    public void setUp() throws Exception {
        ClassloadingDelegateImpl classloadingDelegateImpl = new ClassloadingDelegateImpl(TestImpl.class);

        Dictionary<String, Object> props =
            new Hashtable<String, Object>(ImmutableMap.of(
                Constants.PROVIDED_CLASSES_KEY, new String[]{ TestImpl.class.getName(), "TEST" },
                Constants.PROVIDED_CLASSES_PARENTS_KEY, ITest.class.getName()));
        registerService(classloadingDelegateImpl, props, ClassloadingDelegate.class);

        classLoadingHelper = new DelegatedClassLoadingHelper();
        classLoadingHelper.setBundleContext(bundleContext);
    }
