...
public class WorkflowServiceImpl extends AbstractOpenEngSBService implements WorkflowService, RemoteEventProcessor {
    ...
    public void processEvent(Event event) throws WorkflowException {
        ...
        LOGGER.info("processing Event {} of type {}", event, wrapper.getType());
    ...
    private StringBuffer generateFlowTriggerRule(EventWrapper event, String... flowIds) throws WorkflowException {
        ...
        ruleCode.append(String.format(FLOW_TRIGGER_RULE_TEMPLATE_START, event.getType(), event.getName()));
